<!-- Time-stamp:   <2024.10.12-08:08:21-JST> -->

# MAKDO（MS WordのファイルをMarkdownで編集するアプリ）

[［実行ファイルのダウンロード］](https://makdo.jp/makdo.zip)
...
第２　請求の原因
　１　総論
　　本件の争点は、①本件交通事故発生についての過失割合、②原告車両のドアパネルに<br>
　ついて交換する必要があるか否か、③代車が必要であった期間は１週間か１か月かの３<br>
　点である。
```
...
: 原告訴訟代理人弁護士　　秦　　誠<0.5>一<0.5>郎　㊞（←文字間を0.5文字空ける）
