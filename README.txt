<!-- Time-stamp:   <2022.08.04-17:44:33-JST> -->

# MAKDO

〜〜　わずらわしいナンバリングや字下げからあなたを解放します　〜〜

## これは何？

**一言で言うと、簡単に訴状、答弁書、準備書面、判決書のMS Wordファイルが
作成できるアプリです。**
...
- 「第1、第2…」や「ア、イ…」などのナンバリングを自動でやってくれるようになること
- 字下げを自動でやってくれるようになり、手作業で設定する必要がなくなること
- `grep`コマンドを使って、過去に作成した書面に検索をかけられるようになること
- `diff`コマンドを使って、原稿間の違いを確認できるようになること
