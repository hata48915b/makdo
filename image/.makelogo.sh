...
#cat x0.xpm \
#    | sed 's;#202020200000;white;g' | sed 's;#202000;white;g' \
#    | sed 's;#202060609F9F;white;g' | sed 's;#20609F;white;g' \
#					 > xB.xpm

#convert -quality 100 -resize  512x256!  -depth 8 -colors 512 xB.xpm makdoS.png
