...
chmod 444 makdo8.png makdoL.png
...
#convert -quality 100 -resize 2048x2048! -depth 8 -colors 5 xB.xpm $TMPDIR/icoB.png
...
#convert -quality 100 -resize   64x64!   -depth 8 -colors 5 xB.xpm $TMPDIR/ico6.png
...
#convert -quality 100 -resize  512x256!  -depth 8 -colors 5 xB.xpm $TMPDIR/icoL.png
...
# rm -f makdo8.png makdoL.png
rm -f makdo_splash.png
rm -f makdo_win.ico
rm -f makdo_mac.icns
